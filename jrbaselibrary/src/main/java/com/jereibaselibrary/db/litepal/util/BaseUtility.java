...
package com.jereibaselibrary.db.litepal.util;
...
import com.jereibaselibrary.db.litepal.util.*;
...
public class BaseUtility {
	...
	public static String changeCase(String string) {
		if (string != null) {
			...
			if (com.jereibaselibrary.db.litepal.util.Const.Config.CASES_KEEP.equals(cases)) {
				return string;
			} else if (com.jereibaselibrary.db.litepal.util.Const.Config.CASES_UPPER.equals(cases)) {
        ...
        try {
            ...
            if (fileNames != null && fileNames.length > 0) {
                for (String fileName : fileNames) {
                    if (com.jereibaselibrary.db.litepal.util.Const.Config.CONFIGURATION_FILE_NAME.equalsIgnoreCase(fileName)) {
                        return true;
                    }
                }
            }
