...
import static com.jereibaselibrary.db.litepal.util.BaseUtility.changeCase;
 ...
 * @since 1.1
 */
class SaveHandler extends com.jereibaselibrary.db.litepal.crud.DataHandler {
    ...
    /**
	 * Initialize {@link com.jereibaselibrary.db.litepal.crud.DataHandler#mDatabase} for operating database. Do not
	 ...
	 */
	void onSave(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj) throws SecurityException, IllegalArgumentException,
     ...
     * @throws SecurityException
     */
    void onSaveFast(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj) throws SecurityException, IllegalArgumentException,
            NoSuchMethodException, IllegalAccessException, InvocationTargetException {
	 ...
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#saveAll(Collection)}. Each model in the collection
	 ...
	 * @throws SecurityException
	 */
	<T extends com.jereibaselibrary.db.litepal.crud.DataSupport> void onSaveAll(Collection<T> collection) throws SecurityException,
			IllegalArgumentException, NoSuchMethodException, IllegalAccessException,
			InvocationTargetException {
		if (collection != null && collection.size() > 0) {
			com.jereibaselibrary.db.litepal.crud.DataSupport[] array = collection.toArray(new com.jereibaselibrary.db.litepal.crud.DataSupport[0]);
			com.jereibaselibrary.db.litepal.crud.DataSupport firstObj = array[0];
			String className = firstObj.getClassName();
			List<Field> supportedFields = getSupportedFields(className);
            List<Field> supportedGenericFields = getSupportedGenericFields(className);
			Collection<AssociationsInfo> associationInfos = getAssociationInfo(className);
			for (com.jereibaselibrary.db.litepal.crud.DataSupport baseObj : array) {
				if (!baseObj.isSaved()) {
					analyzeAssociatedModels(baseObj, associationInfos);
					doSaveAction(baseObj, supportedFields, supportedGenericFields);
					analyzeAssociatedModels(baseObj, associationInfos);
	 ...
	 * {@link #beforeSave(com.jereibaselibrary.db.litepal.crud.DataSupport, List, ContentValues)} will be called to
	 * put the values for ContentValues. When the model is saved,
	 * {@link #afterSave(com.jereibaselibrary.db.litepal.crud.DataSupport, List, List, long)} will be called to do stuffs
	 ...
	 * @throws SecurityException
	 */
	private void doSaveAction(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, List<Field> supportedFields, List<Field> supportedGenericFields)
	 ...
	 * @throws SecurityException
	 */
	private void beforeSave(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, List<Field> supportedFields, ContentValues values)
			throws SecurityException, IllegalArgumentException, NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
	 ...
	 */
	private long saving(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, ContentValues values) {
        if (values.size() == 0) {
            values.putNull("id");
        }
	 ...
	 */
	private void afterSave(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, List<Field> supportedFields,
	 ...
	 * @throws SecurityException
	 */
	private void doUpdateAction(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, List<Field> supportedFields, List<Field> supportedGenericFields)
			throws SecurityException, IllegalArgumentException, NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
		values.clear();
	 ...
	 * @throws SecurityException
	 */
	private void beforeUpdate(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, List<Field> supportedFields, ContentValues values)
			throws SecurityException, IllegalArgumentException, NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
		putFieldsValue(baseObj, supportedFields, values);
        if (!ignoreAssociations) {
	 ...
	 *            To store data of current model for updating.
	 */
	private void updating(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, ContentValues values) {
     ...
     *            List of all supported generic fields.
	 */
	private void afterUpdate(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, List<Field> supportedGenericFields)
	 ...
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#baseObjId} will be assigned anyway. If the model has a
	 * field named id or _id, LitePal will assign it too. The
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#baseObjId} will be used as identify of this model for
	 ...
	 *            The value of id.
	 */
	private void assignIdValue(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, Field idField, long id) {
		try {
	 ...
	 * @throws IllegalAccessException
	 */
	private void giveModelIdValue(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, String idName, Class<?> idType, long id)
	 ...
	 */
	private void putForeignKeyValue(ContentValues values, com.jereibaselibrary.db.litepal.crud.DataSupport baseObj) {
	 ...
	 *            Current model that is persisted.
	 */
	private void updateAssociatedTableWithFK(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj) {
	 ...
	 *            Current model that is persisted.
	 */
	private void clearFKValueInAssociatedTable(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj) {
	 ...
	 */
	private void insertIntermediateJoinTableValue(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj, boolean isUpdate) {
	 ...
	 */
	private String getWhereForJoinTableToDelete(com.jereibaselibrary.db.litepal.crud.DataSupport baseObj) {
