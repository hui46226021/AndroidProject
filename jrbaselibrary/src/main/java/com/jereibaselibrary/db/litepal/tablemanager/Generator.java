...
import com.jereibaselibrary.db.litepal.exceptions.DatabaseGenerateException;
import com.jereibaselibrary.db.litepal.parser.LitePalAttr;
import com.jereibaselibrary.db.litepal.tablemanager.*;
import com.jereibaselibrary.db.litepal.tablemanager.Creator;
import com.jereibaselibrary.db.litepal.tablemanager.Dropper;
import com.jereibaselibrary.db.litepal.tablemanager.model.AssociationsModel;
...
public abstract class Generator extends LitePalBase {
	...
	private static void addAssociation(SQLiteDatabase db, boolean force) {
		AssociationCreator associationsCreator = new com.jereibaselibrary.db.litepal.tablemanager.Creator();
	...
	private static void updateAssociations(SQLiteDatabase db) {
		AssociationUpdater associationUpgrader = new com.jereibaselibrary.db.litepal.tablemanager.Upgrader();
	...
	private static void upgradeTables(SQLiteDatabase db) {
		com.jereibaselibrary.db.litepal.tablemanager.Upgrader upgrader = new com.jereibaselibrary.db.litepal.tablemanager.Upgrader();
	...
	private static void create(SQLiteDatabase db, boolean force) {
		com.jereibaselibrary.db.litepal.tablemanager.Creator creator = new com.jereibaselibrary.db.litepal.tablemanager.Creator();
	...
	private static void drop(SQLiteDatabase db) {
		com.jereibaselibrary.db.litepal.tablemanager.Dropper dropper = new Dropper();
