...
import com.jereibaselibrary.db.litepal.crud.ClusterQuery;
import com.jereibaselibrary.db.litepal.crud.DeleteHandler;
import com.jereibaselibrary.db.litepal.crud.QueryHandler;
import com.jereibaselibrary.db.litepal.crud.SaveHandler;
import com.jereibaselibrary.db.litepal.crud.UpdateHandler;
import com.jereibaselibrary.db.litepal.exceptions.DataSupportException;
import com.jereibaselibrary.db.litepal.tablemanager.Connector;
...
public class DataSupport {
	 ...
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#find(Class, long, boolean)}.
	 * 
	 * @param modelClass
	...
	/**
	 * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.DataSupport#find(Class, long)} but an isEager
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#findFirst(Class, boolean)}.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.DataSupport#findFirst(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#findLast(Class, boolean)}.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.DataSupport#findLast(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.jereibaselibrary.db.litepal.crud.DataSupport#findAll(Class, boolean, long...)}.
	 * 
	 * The modelClass determines which table to query and the object type to
	 * return.
	 * 
	...
	/**
	 * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.DataSupport#findAll(Class, long...)} but an
	...
	/**
	 * When updating database with {@link com.jereibaselibrary.db.litepal.crud.DataSupport#update(long)}, you must
