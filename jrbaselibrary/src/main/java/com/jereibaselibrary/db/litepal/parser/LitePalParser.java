...
package com.jereibaselibrary.db.litepal.parser;
...
import com.jereibaselibrary.db.litepal.exceptions.ParseConfigurationFileException;
import com.jereibaselibrary.db.litepal.parser.*;
...
public class LitePalParser {
	 ...
	 */
	public static com.jereibaselibrary.db.litepal.parser.LitePalConfig parseLitePalConfiguration() {
		if (parser == null) {
	 ...
	 * application may be crash.
	 */
    private com.jereibaselibrary.db.litepal.parser.LitePalConfig usePullParse() {
		try {
			com.jereibaselibrary.db.litepal.parser.LitePalConfig litePalConfig = new com.jereibaselibrary.db.litepal.parser.LitePalConfig();
