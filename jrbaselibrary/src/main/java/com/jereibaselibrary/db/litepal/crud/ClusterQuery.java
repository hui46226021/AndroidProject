...
public class ClusterQuery {
	 ...
	 * {@link com.jereibaselibrary.db.litepal.crud.ClusterQuery#find(Class, boolean)}.
	 * 
	 * @param modelClass
	...
	/**
	 * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.ClusterQuery#find(Class)} but an isEager
     ...
     * Note that the associated models won't be loaded by default considering
     * the efficiency, but you can do that by using
     * {@link com.jereibaselibrary.db.litepal.crud.ClusterQuery#findFirst(Class, boolean)}.
     *
     * @param modelClass
    ...
    /**
     * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.ClusterQuery#findFirst(Class)} but an isEager
     * parameter. If set true the associated models will be loaded as well.
     *
     * @param modelClass
     *            Which table to query and the object type to return.
     ...
     * Note that the associated models won't be loaded by default considering
     * the efficiency, but you can do that by using
     * {@link com.jereibaselibrary.db.litepal.crud.ClusterQuery#findLast(Class, boolean)}.
     *
     * @param modelClass
     *            Which table to query and the object type to return.
     * @return An object with founded data from database, or null.
    ...
    /**
     * It is mostly same as {@link com.jereibaselibrary.db.litepal.crud.ClusterQuery#findLast(Class)} but an isEager
     * parameter. If set true the associated models will be loaded as well.
     *
     * @param modelClass
     *            Which table to query and the object type to return.
