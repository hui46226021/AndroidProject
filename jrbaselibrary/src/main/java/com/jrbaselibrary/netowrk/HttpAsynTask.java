  ...
  static   public boolean POST=false;
   static public boolean GET=true;
    ...
    public void putParam(String key,Object object){
        client.putParam(key.trim(),object);
    }
        ...
        try {
            ...
            if (client.hasErrors()) {
                ...
                if(client.getResponseStr().contains("notLogin")){ //掉线
                    //请求失败
                    result.setResultCode(BaseConstant.NetworkConstant.NOT_SESSION);
