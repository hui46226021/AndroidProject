...
package com.jrbaselibrary.db.litepal.parser;

import java.util.ArrayList;
import java.util.List;

import com.jrbaselibrary.db.litepal.exceptions.InvalidAttributesException;
...
public final class LitePalAttr {
	...
	public List<String> getClassNames() {
		if (classNames == null) {
			...
			classNames.add("com.jereibaselibrary.db.litepal.model.Table_Schema");
	 ...
	 * 
	 * @throws com.jrbaselibrary.db.litepal.exceptions.InvalidAttributesException
	 */
