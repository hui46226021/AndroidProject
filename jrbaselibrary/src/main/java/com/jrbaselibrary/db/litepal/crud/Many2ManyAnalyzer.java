...
public class Many2ManyAnalyzer extends AssociationsAnalyzer {
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelForJoinTable(String, long)} will be called
	...
	/**
	 * This add an empty set for {@link com.jrbaselibrary.db.litepal.crud.DataSupport#associatedModelsMapForJoinTable}.
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#associatedModelsMapForJoinTable} for
	...
	/**
	 * Get the associated table name by {@link com.jrbaselibrary.db.litepal.crud.model.AssociationsInfo} after case
	 * changed.
	 * 
	 * @param associationInfo
