...
import com.jrbaselibrary.db.litepal.annotation.Encrypt;
...
import static com.jrbaselibrary.db.litepal.util.BaseUtility.changeCase;
...
class SaveHandler extends DataHandler {
    ...
    /**
	 * Initialize {@link com.jrbaselibrary.db.litepal.crud.DataHandler#mDatabase} for operating database. Do not
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#saveAll(Collection)}. Each model in the collection
	 ...
	 * {@link #beforeSave(com.jrbaselibrary.db.litepal.crud.DataSupport, List, ContentValues)} will be called to
	 * put the values for ContentValues. When the model is saved,
	 * {@link #afterSave(com.jrbaselibrary.db.litepal.crud.DataSupport, List, List, long)} will be called to do stuffs
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#baseObjId} will be assigned anyway. If the model has a
	 * field named id or _id, LitePal will assign it too. The
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#baseObjId} will be used as identify of this model for
