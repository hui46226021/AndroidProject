...
import com.jrbaselibrary.db.litepal.LitePalBase;
...
class Many2OneAnalyzer extends AssociationsAnalyzer {
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelWithFK(String, long)} and
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelWithoutFK(String, long)} will be
	 ...
	 * and calling
	 * {@link #dealAssociatedModelOnManySide(Collection, com.jrbaselibrary.db.litepal.crud.DataSupport, com.jrbaselibrary.db.litepal.crud.DataSupport)}
	 * to set foreign key.
	 * 
	 * @param baseObj
	 ...
	 * {@link #buildBidirectionalAssociations(com.jrbaselibrary.db.litepal.crud.DataSupport, com.jrbaselibrary.db.litepal.crud.DataSupport, com.jrbaselibrary.db.litepal.crud.model.AssociationsInfo)}
	 * to build bidirectional association if they haven't built yet. Then calls
	 * {@link #dealAssociatedModelOnOneSide(com.jrbaselibrary.db.litepal.crud.DataSupport, com.jrbaselibrary.db.litepal.crud.DataSupport)} to set
	 * foreign key.
	 * 
	 * @param baseObj
	 *            The baseObj currently want to persist.
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelWithFK(String, long)}.
	 * 
