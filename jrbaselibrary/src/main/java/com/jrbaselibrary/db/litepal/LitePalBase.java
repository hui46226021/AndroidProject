...
import com.jrbaselibrary.db.litepal.annotation.Column;
import com.jrbaselibrary.db.litepal.crud.DataSupport;
import com.jrbaselibrary.db.litepal.crud.model.AssociationsInfo;
import com.jrbaselibrary.db.litepal.exceptions.DatabaseGenerateException;
import com.jrbaselibrary.db.litepal.parser.LitePalAttr;
import com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel;
import com.jrbaselibrary.db.litepal.tablemanager.model.ColumnModel;
import com.jrbaselibrary.db.litepal.tablemanager.model.GenericModel;
import com.jrbaselibrary.db.litepal.tablemanager.model.TableModel;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.BlobOrm;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.BooleanOrm;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.DateOrm;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.DecimalOrm;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.NumericOrm;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.OrmChange;
import com.jrbaselibrary.db.litepal.tablemanager.typechange.TextOrm;
import com.jrbaselibrary.db.litepal.util.BaseUtility;
import com.jrbaselibrary.db.litepal.util.Const;
import com.jrbaselibrary.db.litepal.util.DBUtility;
...
public abstract class LitePalBase {
	 ...
	 *            The class name to introspection.
	 * @param action
	 *            Between {@link com.jrbaselibrary.db.litepal.LitePalBase#GET_ASSOCIATIONS_ACTION} and
	 *            {@link com.jrbaselibrary.db.litepal.LitePalBase#GET_ASSOCIATION_INFO_ACTION}
	 */
	...
	/**
	 * Package a {@link com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel}, and add it into
	 * {@link #mAssociationModels} Collection.
	 * 
	 * @param className
	 *            The class name for {@link com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel}.
	 * @param associatedClassName
	 *            The associated class name for {@link com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel}.
	 * @param classHoldsForeignKey
	 *            The class which holds foreign key.
	 * @param associationType
	 *            The association type for {@link com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel}.
	 */
	...
	/**
	 * Package a {@link com.jrbaselibrary.db.litepal.crud.model.AssociationsInfo}, and add it into
