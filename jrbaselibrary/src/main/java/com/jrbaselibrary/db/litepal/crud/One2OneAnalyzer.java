...
public class One2OneAnalyzer extends AssociationsAnalyzer {
	 ...
	 * {@link #bidirectionalCondition(com.jrbaselibrary.db.litepal.crud.DataSupport, com.jrbaselibrary.db.litepal.crud.DataSupport)}. If it's
	 * unidirectional association, calls
	 * {@link #unidirectionalCondition(com.jrbaselibrary.db.litepal.crud.DataSupport, com.jrbaselibrary.db.litepal.crud.DataSupport)}.
	 * 
	 * @param baseObj
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelWithFK(String, long)}. Add its' name
	 * and id to baseObj by calling
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelWithoutFK(String, long)}.
	 * 
	 * @param baseObj
	 *            The baseObj currently want to persist.
	 * @param associatedModel
