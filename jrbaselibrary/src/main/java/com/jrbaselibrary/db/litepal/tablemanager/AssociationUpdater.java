...
package com.jrbaselibrary.db.litepal.tablemanager;
...
import com.jrbaselibrary.db.litepal.util.LogUtil;
 ...
 * {@link com.jrbaselibrary.db.litepal.tablemanager.AssociationUpdater}. So this class just deal with the simple job of
...
public abstract class AssociationUpdater extends Creator {
	...
	/**
	 * Analysis the {@link com.jrbaselibrary.db.litepal.tablemanager.model.TableModel} by the purpose of subclasses, and
	...
	/**
	 * {@link com.jrbaselibrary.db.litepal.tablemanager.AssociationUpdater} does two jobs. Removing foreign key columns
	 ...
	 * @throws com.jrbaselibrary.db.litepal.exceptions.DatabaseGenerateException
	 */
	 ...
	 * only used in {@link #findForeignKeyToRemove(com.jrbaselibrary.db.litepal.tablemanager.model.TableModel)} when iterating
	...
	/**
	 * Judge if the tableName1 equals {@link com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel#getTableName()}
	 * and tableName2 equals {@link com.jrbaselibrary.db.litepal.tablemanager.model.AssociationsModel#getAssociatedTableName()}.
	 * 
