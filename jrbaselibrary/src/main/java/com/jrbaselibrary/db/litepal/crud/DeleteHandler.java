...
class DeleteHandler extends DataHandler {
	 ...
	 * already(using {@link com.jrbaselibrary.db.litepal.crud.DataSupport#isSaved()} to test), or nothing will be
	 ...
	 * {@link #analyzeAssociations(com.jrbaselibrary.db.litepal.crud.DataSupport)}. There're two parts of
