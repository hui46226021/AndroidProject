...
package com.jrbaselibrary.db.litepal.crud;

import android.content.ContentValues;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.jrbaselibrary.db.litepal.LitePal;
import com.jrbaselibrary.db.litepal.annotation.Primarykey;
import com.jrbaselibrary.db.litepal.crud.async.AverageExecutor;
import com.jrbaselibrary.db.litepal.crud.async.CountExecutor;
import com.jrbaselibrary.db.litepal.crud.async.FindExecutor;
import com.jrbaselibrary.db.litepal.crud.async.FindMultiExecutor;
import com.jrbaselibrary.db.litepal.crud.async.SaveExecutor;
import com.jrbaselibrary.db.litepal.crud.async.UpdateOrDeleteExecutor;
import com.jrbaselibrary.db.litepal.exceptions.DataSupportException;
import com.jrbaselibrary.db.litepal.tablemanager.Connector;
...
public class DataSupport {
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#find(Class, long, boolean)}.
	 * 
	 * @param modelClass
	...
	/**
	 * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.DataSupport#find(Class, long)} but an isEager
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#findFirst(Class, boolean)}.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.DataSupport#findFirst(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
     * <br>
     * Note that isEager will only work for one deep level relation, considering the query efficiency.
     * You have to implement on your own if you need to load multiple deepness of relation at once.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#findLast(Class, boolean)}.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.DataSupport#findLast(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
     * <br>
     * Note that isEager will only work for one deep level relation, considering the query efficiency.
     * You have to implement on your own if you need to load multiple deepness of relation at once.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.jrbaselibrary.db.litepal.crud.DataSupport#findAll(Class, boolean, long...)}.
	 * 
	 * The modelClass determines which table to query and the object type to
	 * return.
	 * 
	...
	/**
	 * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.DataSupport#findAll(Class, long...)} but an
		...
		for(Field field : fields){
			...
			if (primarykey != null){
				try {
					...
					saveOrUpdate(field.getName()+ " = ?",value.toString());
	...
	/**
	 * When updating database with {@link com.jrbaselibrary.db.litepal.crud.DataSupport#update(long)}, you must
