...
public class ClusterQuery {
	 ...
	 * {@link com.jrbaselibrary.db.litepal.crud.ClusterQuery#find(Class, boolean)}.
	 * 
	 * @param modelClass
	...
	/**
	 * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.ClusterQuery#find(Class)} but an isEager
     ...
     * Note that the associated models won't be loaded by default considering
     * the efficiency, but you can do that by using
     * {@link com.jrbaselibrary.db.litepal.crud.ClusterQuery#findFirst(Class, boolean)}.
     *
     * @param modelClass
    ...
    /**
     * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.ClusterQuery#findFirst(Class)} but an isEager
     * parameter. If set true the associated models will be loaded as well.
     * <br>
     * Note that isEager will only work for one deep level relation, considering the query efficiency.
     * You have to implement on your own if you need to load multiple deepness of relation at once.
     ...
     * Note that the associated models won't be loaded by default considering
     * the efficiency, but you can do that by using
     * {@link com.jrbaselibrary.db.litepal.crud.ClusterQuery#findLast(Class, boolean)}.
     *
     * @param modelClass
     *            Which table to query and the object type to return.
     * @return An object with founded data from database, or null.
    ...
    /**
     * It is mostly same as {@link com.jrbaselibrary.db.litepal.crud.ClusterQuery#findLast(Class)} but an isEager
     * parameter. If set true the associated models will be loaded as well.
     * <br>
     * Note that isEager will only work for one deep level relation, considering the query efficiency.
     * You have to implement on your own if you need to load multiple deepness of relation at once.
