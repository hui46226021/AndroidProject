...
abstract class AssociationsAnalyzer extends DataHandler {
	 ...
	 * calling {@link com.jrbaselibrary.db.litepal.crud.DataSupport#addAssociatedModelWithFK(String, long)}. Or if
	...
	/**
	 * Get foreign key name by {@link com.jrbaselibrary.db.litepal.crud.model.AssociationsInfo}.
	 * 
	 * @param associationInfo
