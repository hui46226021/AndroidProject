...
//        private float centerY;
        private float startHeight;
        private float endHeight;
        private int nDirection = ViewAnimUtils.RECT_TOP;
