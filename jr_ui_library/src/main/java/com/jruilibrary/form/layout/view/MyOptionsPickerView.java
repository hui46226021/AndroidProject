...
public class MyOptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public MyOptionsPickerView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(com.bigkoo.pickerview.R.layout.pickerview_options, contentContainer);
        // -----确定和取消按钮
        ...
        // ----转轮
        final View optionspicker = findViewById(com.bigkoo.pickerview.R.id.optionspicker);
    ...
    public void setSelecedItem(int option1,int option2,int option3){
        ...
        if(optionsSelectListener!=null)
        {
            optionsSelectListener.onOptionsSelect(option1, option2, option3);
        }
    }
