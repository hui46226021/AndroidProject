...
public class OptionDialog {
    ...
    List<OptionModel> lsit = new ArrayList<OptionModel>() ;
    ...
    public  Dialog createLoadingDialog(Context context, final List<OptionModel> list1) {
    ...
    static class SpinnerAdapter extends BaseAdapter {
         ...
         public SpinnerAdapter(Context context, List<OptionModel> listData) {
         ...
         public View getView(int position, View convertView, ViewGroup parent) {
             ...
             OptionModel map = (OptionModel) getItem(position);
    ...
    public static interface SelectedCall{
        public void selectedCall(OptionModel spinnerModel);
    }
}
