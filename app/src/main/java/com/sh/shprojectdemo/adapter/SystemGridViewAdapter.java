...
public class SystemGridViewAdapter extends BaseAdapter {
    ...
    List<String> menuModels;


    public SystemGridViewAdapter(Context context, List<String> menuModels ) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = LayoutInflater.from(context).inflate(R.layout.grid_system_menu_layout, parent, false);
        ...
        holder.tv_goods_name.setText(text);
        return convertView;
    }
