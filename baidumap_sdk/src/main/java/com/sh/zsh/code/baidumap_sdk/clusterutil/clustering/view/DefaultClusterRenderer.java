...
package com.sh.zsh.code.baidumap_sdk.clusterutil.clustering.view;
...
import com.sh.zsh.code.baidumap_sdk.clusterutil.MarkerManager;
...
import com.sh.zsh.code.baidumap_sdk.clusterutil.projection.Point;
import com.sh.zsh.code.baidumap_sdk.clusterutil.projection.SphericalMercatorProjection;
import com.sh.zsh.code.baidumap_sdk.clusterutil.ui.IconGenerator;
...
import com.sh.zsh.code.baidumap_sdk.clusterutil.ui.SquareTextView;
...
import static com.sh.zsh.code.baidumap_sdk.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
            for (T item : cluster.getItems()){
                Bitmap bitmap= item.getBitmapDescriptor().getBitmap();
                descriptor = BitmapDescriptorFactory.fromBitmap(mIconGenerator.makeIcon(getClusterText(bucket),bitmap));
//                mColoredCircleBackground.getPaint().setColor(getColor(bucket));
    ...
    private class CreateMarkerTask {
        ...
        private void perform(MarkerModifier markerModifier) {
            ...
            if (!shouldRenderAsCluster(cluster)) {
                for (T item : cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        marker = mClusterManager.getMarkerCollection().addMarker(markerOptions,true);
            ...
            Marker marker = mClusterManager.getClusterMarkerCollection().addMarker(markerOptions,false);
