...
import com.sh.zsh.code.baidumap_sdk.clusterutil.Constant;
...
import com.sh.zsh.code.baidumap_sdk.clusterutil.projection.Bounds;
...
import com.sh.zsh.code.baidumap_sdk.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final double zoomSpecificSpan = MAX_DISTANCE_AT_ZOOM / Math.pow(2, discreteZoom) / Constant.DENSITY;
